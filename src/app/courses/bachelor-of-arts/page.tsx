...
export const metadata: Metadata = {
  ...
  keywords: 'Bachelor of Arts (BA), Undergraduate, education, course, EDBELL',
  openGraph: {
    title: 'Bachelor of Arts (BA) - EDBELL EDUSOLUTIONS',
    description: 'Comprehensive liberal arts program with literature, history, and political science specializations.',
    type: 'website',
...
export default function BachelorofArtsBAPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Comprehensive liberal arts program with literature, history, and political science specializations.
            </p>
            <div className="flex flex-wrap justify-center gap-4 text-sm">
              ...
              <div className="bg-white/10 px-4 py-2 rounded-full flex items-center space-x-2">
                ...
                <span>Fees: ₹30,000 per year</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div className="bg-purple-50 p-6 rounded-lg">
                  ...
                  <p className="text-purple-600 font-medium">₹30,000 per year</p>
                </div>
                <div className="bg-yellow-50 p-6 rounded-lg">
                  <h3 className="font-semibold text-gray-900 mb-2">Eligibility</h3>
                  <p className="text-yellow-600 font-medium">12th Pass from any stream</p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6 sticky top-8">
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-green-600">₹30,000 per year</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Eligibility:</span>
                  <span className="font-medium">12th Pass from any stream</span>
                </div>
              </div>
