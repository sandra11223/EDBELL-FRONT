...
export const metadata: Metadata = {
  title: 'Test Course API - Online Degree Program | EDBELL EDUSOLUTIONS',
  description: 'This is a test course to verify the API is working correctly',
  keywords: 'Test Course API, online course, undergraduate, distance education, UGC approved',
  openGraph: {
    title: 'Test Course API - Online Degree Program',
    description: 'This is a test course to verify the API is working correctly',
    type: 'article',
    url: 'https://edbelledusolutions.com/courses/test-course-api',
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://edbelledusolutions.com/courses/test-course-api',
  },
};
...
export default function CoursePage() {
  const course = {
    ...
    description: "This is a test course to verify the API is working correctly",
    curriculum: "Comprehensive curriculum designed by industry experts",
    careerOpportunities: "Wide range of career opportunities in various sectors",
