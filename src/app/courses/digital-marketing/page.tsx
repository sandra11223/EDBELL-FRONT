...
export const metadata: Metadata = {
  title: 'Digital Marketing Certification - EDBELL EDUSOLUTIONS',
  description: 'Comprehensive digital marketing program covering SEO, social media marketing, Google Ads, content marketing.',
  keywords: 'Digital Marketing Certification, Specialized, education, course, EDBELL',
  openGraph: {
    title: 'Digital Marketing Certification - EDBELL EDUSOLUTIONS',
    description: 'Comprehensive digital marketing program covering SEO, social media marketing, Google Ads, content marketing.',
    type: 'website',
          ...
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4 text-sm">
              ...
              <div className="bg-white/10 px-4 py-2 rounded-full flex items-center space-x-2">
                ...
                <span>Category: Specialized</span>
              </div>
              <div className="bg-white/10 px-4 py-2 rounded-full flex items-center space-x-2">
                <Users className="h-4 w-4" />
                <span>Fees: ₹25,000</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div className="bg-green-50 p-6 rounded-lg">
                  ...
                  <p className="text-green-600 font-medium">Specialized</p>
                </div>
                <div className="bg-purple-50 p-6 rounded-lg">
                  <h3 className="font-semibold text-gray-900 mb-2">Fees</h3>
                  <p className="text-purple-600 font-medium">₹25,000</p>
                </div>
                <div className="bg-yellow-50 p-6 rounded-lg">
                  <h3 className="font-semibold text-gray-900 mb-2">Eligibility</h3>
                  <p className="text-yellow-600 font-medium">12th Pass or Graduate</p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6 sticky top-8">
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">12th Pass or Graduate</span>
                </div>
              </div>
